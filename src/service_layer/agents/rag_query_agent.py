...
class RAGQueryAgent:
    ...
    def _build_unified_prompt(
        ...
        template = """你是一个专业的智能投资助手。请根据以下知识库内容回答用户问题：
...
⚠️ 重要提示：
1. 请严格返回上述JSON格式之一，不要添加其他内容
2. 选股结果最多返回{top_k}只股票
3. 如果参考文档中没有足够信息，请明确说明
4. reason字段要简洁明了，突出为什么符合条件
"""
